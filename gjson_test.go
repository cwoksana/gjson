...
func TestNestedArray(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "nested_array_array_field",
			jsonPath: "nestedArray.#.nestedArray.#.value",
			body:     `{"name":"object1","nestedArray":[{"name":"nested 1","nestedArray":[{"name":"nested 2","value":[1,2,3]},{"name":"nested 3","value":[4,5]}]},{"name":"nested 4","nestedArray":[{"name":"nested 5","value":[6,7,8]},{"name":"nested 6","value":[9,10]}]}]}`,
			res: []Result{
				{
					Type:  JSON,
					Raw:   `[1,2,3]`,
